...
if config.get_setting("updatecheck2") == "true":
    ...
    try:
        ...
        if version:
            import xbmcgui
            yes_pressed = xbmcgui.Dialog().yesno( "Versione "+version+" disponibile" , " Vuoi installarla ?" )
        ...
        advertencia.ok("Impossibile connettersi", "Non è stato possibile verificare nuovi aggiornamenti", "Aggiornamenti")
