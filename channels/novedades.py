...
def mainlist(item,thumbnail_type="squares"):
    ...
    itemlist.append(Item(channel=item.channel, action="novedades", extra="infantiles", title="Cartoni animati", thumbnail=thumbnail))

    if list_canales['series']:
        thumbnail = thumbnail_base + "/thumb_canales_series.png"
    itemlist.append(Item(channel=item.channel, action="novedades", extra="series", title="Episodi serie TV", thumbnail=thumbnail))

    if list_canales['anime']:
        thumbnail = thumbnail_base + "/thumb_canales_anime.png"
    itemlist.append(Item(channel=item.channel, action="novedades", extra="anime", title="Episodi di Anime", thumbnail=thumbnail))
